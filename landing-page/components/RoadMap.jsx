...
const RoadMap = () => {
	return (
		<div className="px-8 py-16 min-h-screen">
			...
			<p className="mb-16 text-center w-1/2 mx-auto">Our commitment to build Halal ecosystem around DeFi is really strong. We are aiming to have the following roadmap get realized in timely manner</p>
			<div>
