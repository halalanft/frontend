...
const RoadMap = () => {
  return (
    <div
      id="roadmap"
      className="px-8 py-16 min-h-screen w-screen bg-roadmap lg:bg-cover max-sm:bg-contain"
    >
      <h1 className="text-4xl font-impact mb-8 text-center text-[#171717] opacity-[0.68] ">
